<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/bd196cf1072f48afae5676066a72e297.jpg) fixed no-repeat center top / 100% 100%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="票务编号" prop="piaowubianhao">
					<el-input v-model="ruleForm.piaowubianhao" placeholder="票务编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.piaowubianhao" label="票务编号" prop="piaowubianhao">
					<el-input v-model="ruleForm.piaowubianhao" placeholder="票务编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="票务名称" prop="piaowumingcheng">
					<el-input v-model="ruleForm.piaowumingcheng" placeholder="票务名称" clearable  :readonly="ro.piaowumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="票务名称" prop="piaowumingcheng">
					<el-input v-model="ruleForm.piaowumingcheng" placeholder="票务名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="票务类型" prop="piaowuleixing">
					<el-input v-model="ruleForm.piaowuleixing" placeholder="票务类型" clearable  :readonly="ro.piaowuleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="票务类型" prop="piaowuleixing">
					<el-input v-model="ruleForm.piaowuleixing" placeholder="票务类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="目的地" prop="mudedi">
					<el-input v-model="ruleForm.mudedi" placeholder="目的地" clearable  :readonly="ro.mudedi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="目的地" prop="mudedi">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xiangqing" label="详情" prop="xiangqing">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.xiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmt7i6n/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
