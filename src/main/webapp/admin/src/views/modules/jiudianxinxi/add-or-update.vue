<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/bd196cf1072f48afae5676066a72e297.jpg) fixed no-repeat center top / 100% 100%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="酒店编号" prop="jiudianbianhao">
					<el-input v-model="ruleForm.jiudianbianhao" placeholder="酒店编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jiudianbianhao" label="酒店编号" prop="jiudianbianhao">
					<el-input v-model="ruleForm.jiudianbianhao" placeholder="酒店编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="酒店类型" prop="jiudianleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.jiudianzhaopian" label="酒店照片" prop="jiudianzhaopian">
					<file-upload
						tip="点击上传酒店照片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.jiudianzhaopian" label="酒店照片" prop="jiudianzhaopian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiudianzhaopian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="酒店简介" prop="jiudianjianjie">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jiudianjianjie" label="酒店简介" prop="jiudianjianjie">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jiudianjianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="酒店详情" prop="jiudianxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jiudianxiangqing" label="酒店详情" prop="jiudianxiangqing">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiudianxiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiudianxiangqing = this.ruleForm.jiudianxiangqing.replace(reg,'../../../ssmt7i6n/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jiudianzhaopian!=null) {
		this.ruleForm.jiudianzhaopian = this.ruleForm.jiudianzhaopian.replace(new RegExp(this.$base.url,"g"),"");
	}
