<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/bd196cf1072f48afae5676066a72e297.jpg) fixed no-repeat center top / 100% 100%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="套餐编号" prop="taocanbianhao">
					<el-input v-model="ruleForm.taocanbianhao" placeholder="套餐编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.taocanbianhao" label="套餐编号" prop="taocanbianhao">
					<el-input v-model="ruleForm.taocanbianhao" placeholder="套餐编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="套餐标题" prop="taocanbiaoti">
					<el-input v-model="ruleForm.taocanbiaoti" placeholder="套餐标题" clearable  :readonly="ro.taocanbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="套餐标题" prop="taocanbiaoti">
					<el-input v-model="ruleForm.taocanbiaoti" placeholder="套餐标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="套餐类型" prop="taocanleixing">
					<el-input v-model="ruleForm.taocanleixing" placeholder="套餐类型" clearable  :readonly="ro.taocanleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="套餐类型" prop="taocanleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="套餐简介" prop="taocanjianjie">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.taocanjianjie" label="套餐简介" prop="taocanjianjie">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}'>{{ruleForm.taocanjianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="套餐详情" prop="taocanxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.taocanxiangqing" label="套餐详情" prop="taocanxiangqing">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.taocanxiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.taocanxiangqing = this.ruleForm.taocanxiangqing.replace(reg,'../../../ssmt7i6n/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `taocanchanpin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.taocanchanpinCrossAddOrUpdateFlag = false;
						 this.parent.search();
