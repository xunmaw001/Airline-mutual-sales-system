...
<div class="recommend" :style='{"width":"100%","padding":"20px 0 30px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230127/cb48feb1ff1b497faa783e042fab17b3.jpg) repeat-y center top / 100% 100%"}'>
    ...
    <div class="title" :style='{"minHeight":"50px","padding":"0 0 30px","margin":"60px auto 40px","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230127/08c16dc8bbc641d9b10f2c8403aeb7f1.png) no-repeat center bottom","display":"flex","width":"100%","justifyContent":"center"}'>
		<span :style='{"color":"#fff","fontSize":"30px","lineHeight":"50px"}'>酒店信息推荐</span>
	</div>
	...
	<div class="list list2 index-pv1" :style='{"padding":"0 7%","margin":"20px 0 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"margin":"0 0 30px","flexWrap":"wrap","background":"#fff","display":"flex","width":"23.5%","fontSize":"0","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(item,index) in jiudianxinxiRecommend" class="list-item animation-box" :key="index" @click="toDetail('jiudianxinxiDetail', item)">
			<img :style='{"border":"none","padding":"10px 10px 60px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230127/ef04f1f0d78145d4b55871efdc1e6549.png) no-repeat center bottom / 100% auto,#7dd8ee","display":"inline-block","width":"100%","height":"380px"}' v-if="preHttp(item.jiudianzhaopian)" :src="item.jiudianzhaopian.split(',')[0]" alt="" />
			<img :style='{"border":"none","padding":"10px 10px 60px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230127/ef04f1f0d78145d4b55871efdc1e6549.png) no-repeat center bottom / 100% auto,#7dd8ee","display":"inline-block","width":"100%","height":"380px"}' v-else :src="baseUrl + (item.jiudianzhaopian?item.jiudianzhaopian.split(',')[0]:'')" alt="" />
			<div class="item-info" :style='{"width":"100%","padding":"10px 0","verticalAlign":"middle","overflow":"hidden","display":"inline-block","height":"100%"}'>
				<div class="name line1" :style='{"margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","width":"100%","lineHeight":"40px","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500","height":"40px"}'>{{item.jiudianmingcheng}}</div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('jiudianxinxi')" :style='{"padding":"0 20px","margin":"10px auto","textAlign":"center","background":"none","display":"inline-block","width":"100%","lineHeight":"40px"}'>
...
<div class="news" :style='{"width":"100%","margin":"0","position":"relative","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230127/9a8312998bcc4b55aefae7725f58f713.jpg) no-repeat center top","display":"block"}'>
	...
	<div class="title" :style='{"width":"100%","padding":"0 0 40px","margin":"60px auto 40px","lineHeight":"50px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230127/9b960911d44148759e8047661d17347b.png) no-repeat center bottom"}'>
		<span :style='{"color":"#15a6e1","fontSize":"32px"}'>航班资讯</span>
	</div>
...
<div class="lists" :style='{"width":"100%","padding":"30px 7%","margin":"0 auto","position":"relative","background":"url(http://codegen.caihongy.cn/20230127/3dc7a96395244ef894fde9c1deda72e9.jpg) no-repeat center bottom,linear-gradient(180deg, rgba(209,238,254,1) 0%, rgba(252,253,254,1) 40%, rgba(252,253,254,1) 100%),#fcfdfe","display":"block"}'>
	...
	<div class="title" :style='{"margin":"0 auto 20px","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230127/9b960911d44148759e8047661d17347b.png) no-repeat center bottom","display":"flex","width":"100%","lineHeight":"50px","justifyContent":"center"}'>
	  <span :style='{"padding":"0 0 30px","fontSize":"32px","lineHeight":"50px","color":"#111"}'>票务信息展示</span>
	</div>
	...
	<div class="list list5 index-pv1">
		<div id="lists-five-swiperpiaowuxinxi" class="swiper-container lists-five-swiper" :style='{"width":"100%","padding":"50px 10px","margin":"40px 0 0","background":"none"}'>
			<div class="swiper-wrapper">
				<div :style='{"border":"0","padding":"20px","fontSize":"0","position":"relative","borderRadius":"4px","background":"none"}' class="swiper-slide" v-for="(item,index) in piaowuxinxiList" :key="index" @click="toDetail('piaowuxinxiDetail', item)">
					<img :style='{"border":"0","width":"200px","padding":"40px 20px","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","height":"220px"}' v-if="preHttp(item.fengmian)" :src="item.fengmian.split(',')[0]" alt="" />
					<img :style='{"border":"0","width":"200px","padding":"40px 20px","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","height":"220px"}' v-else :src="baseUrl + (item.fengmian?item.fengmian.split(',')[0]:'')" alt="" />
				</div>
			</div>
			<!-- Add Arrows -->
	...
	<div @click="moreBtn('piaowuxinxi')" :style='{"border":"0","padding":"0 20px","margin":"40px auto 50px","textAlign":"center","background":"none","display":"inline-block","width":"100%","lineHeight":"40px"}'>
		<span :style='{"color":"#3e97c6","fontSize":"18px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#3e97c6","fontSize":"18px"}' class="el-icon-d-arrow-right"></i>
	</div>
      ...
      getSystemIntroduction() {
		...
		getList() {
          ...
          autoSortUrl = "jiudianxinxi/autoSort";
			...
			this.$http.get('piaowuxinxi/list', {params: {
				page: 1,
				limit: 8,
			}}).then(res => {
				if (res.data.code == 0) {
					this.piaowuxinxiList = res.data.data.list;
					
					// 商品列表样式五
					this.$nextTick(() => {
						new Swiper('#lists-five-swiperpiaowuxinxi', {
							loop: true,
							speed: 500,
