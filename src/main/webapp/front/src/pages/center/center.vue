    ...
    <el-tabs tab-position="left" :style='{"background":"none"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="150px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="商家电话" prop="shangjiadianhua">
            <el-input v-model="sessionForm.shangjiadianhua" placeholder="商家电话" ></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('shangjia' == this.userTableName) {
        this.$set(this.sessionForm, 'shangjiadianhua', null);
      }
      if ('shangjia' == this.userTableName) {
        this.$set(this.sessionForm, 'money', null);
      }
      ...
      if ('shangjia' == this.userTableName) {
        this.$set(this.rules, 'shangjiamingcheng', [{ required: true, message: '请输入商家名称', trigger: 'blur' }]);
			...
			if ('shangjia' == this.userTableName) {
        this.$set(this.rules, 'shangjiadianhua', [{ required: false, validator: this.$validate.isMobile, trigger: 'blur' }]);
      }
			if ('shangjia' == this.userTableName) {
        this.$set(this.rules, 'money', [{ required: false, validator: this.$validate.isNumber, trigger: 'blur' }]);
      }
