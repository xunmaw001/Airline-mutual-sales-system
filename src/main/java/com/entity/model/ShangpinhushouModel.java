 ...
 */
public class ShangpinhushouModel  implements Serializable {
	...
	private String shangpinzhaopian;
	...
	public void setShangpinzhaopian(String shangpinzhaopian) {
		this.shangpinzhaopian = shangpinzhaopian;
	}
	
	/**
	 * 获取：商品照片
	 */
	public String getShangpinzhaopian() {
		return shangpinzhaopian;
	}
